...
## Stack
- **React 18** + **Vite 5**
- **Tailwind CSS v4** (`@theme` con tokens de color CMY)
- **GSAP 3 + ScrollTrigger** (animación de scroll scrub con canvas de 85 frames, botones magnéticos)
- **Framer Motion** (animaciones de interfaz: typewriter, reveals, acordeón FAQ, botón flotante)
...
npm test          # ejecutar pruebas E2E con Playwright
```
...
- `FORM_ENDPOINT` — endpoint para envíos de contacto (FormSubmit)
...
- `gallery/event1.webp` ... `event6.webp` — fotos de eventos optimizadas
- `team.webp` — foto del equipo para la sección Nosotros
